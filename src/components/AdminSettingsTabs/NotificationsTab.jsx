        ...
        <div className="p-8 flex flex-col gap-6">
          ...
          <div className="flex items-center justify-between bg-gray-50 p-4 rounded-xl">
            <div className="flex items-start gap-3">
              <Package size={18} className="text-secondary mt-0.5" />
              <div className="flex flex-col">
                <span className="font-bold text-sm text-primary">New Order Alerts</span>
                <span className="text-xs text-gray-500">Receive an email when a new order is placed</span>
              </div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input type="checkbox" className="sr-only peer" checked={settings.email_new_orders} onChange={(e) => setSettings({...settings, email_new_orders: e.target.checked})} />
